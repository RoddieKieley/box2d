...
func (joint *B2PulleyJoint) Dump() {
	...
	fmt.Printf("  jd.lengthA = %.15ef;\n", joint.M_lengthA)
	fmt.Printf("  jd.lengthB = %.15ef;\n", joint.M_lengthB)
	fmt.Printf("  jd.ratio = %.15ef;\n", joint.M_ratio)
